...
st.title("Recomendações Oncológicas com IA")
...
if st.button("Obter Recomendações"):
    if nome.strip() and informacoes_medicas.strip():
        ...
        label_map_invertido = {v: k for k, v in label_map.items()}  # Certifique-se de definir label_map antes
        ...
        st.write(f"**Histórico Médico:** {informacoes_medicas}")
